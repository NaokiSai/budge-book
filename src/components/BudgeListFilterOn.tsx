...
export const BudgeListFilterOn = (props: BudgeListFilterOnProps) => {
  const { setSelectedDate, setOpenTimeoutDialog, inputData, categoryFilter } = props
  ...
  const filteredData = categoryFilter
    ? inputData.filter((entry) => entry.category === categoryFilter)
    : inputData;
